...
{"Deudores diversos"},{"Anticipo proveedores"},{"IVA acreditable"},{"IVA pendiente de acreditar"}};
...
{"Gastos de mercadotecnia"},{"Gastos de organizacion"},{"Gastos de instalacion"},
{"Papeleria y utiles"},{"Propaganda y publicidad"},{"Primas de seguros"},
...
{"Anticipo a clientes"},{"Gastos pendientes de pago"},
{"Impuestos pendientes de pago"},{"IVA pendiente de pago"},{"Retencion a terceros"}};
...
char otros[15][50]={{"Ventas"},{"Devolucion y rebajas s/ventas"},{"Compras"},{"Gastos compra"},{"Devoluciones y rebajas s/compras"},{"Inventario inicial"},
{"Inventario final"},{"Gastos generales"},{"Otros productos"},{"Otros gastos"},{"Productos Financieros"},{"Gastos financieros "}};
...
gotoxy(15,27);printf(" ");
gotoxy(15,26);printf(" ");
gotoxy(15,26);printf("Desea ingresar otra cuenta Si=1, NO=0, ver codigos de cuenta=2 : ");
scanf("%d",&opc2);
opc=opc2;
if(opc==2){
gotoxy(15,27);printf("activo- circulante=1, fijo=2, diferido=3");
...
gotoxy(15,28);printf(" ");
gotoxy(15,29);printf(" ");
gotoxy(15,26);printf("No puede continuar, no existe partida doble ");
gotoxy(15,27);printf("Movimiento a modificar Cargo=1, Abono=0, ingresar otra cuenta=2 : ");
scanf("%d",&opc1);
if(opc1==1||opc1==0){
...
gotoxy(15,28);printf("Pulse una tecla para continuar...");
}
}
opc2=0;
}
